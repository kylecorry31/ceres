...
class CeresListView(context: Context, attrs: AttributeSet?) : RecyclerView(context, attrs) {

    private val list =
        ListView(this, R.layout.ceres_list_item) { view: View, listItem: ListItem ->
            val binding = CeresListItemBinding.bind(view)
